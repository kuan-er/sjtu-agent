...
做校园功能之前，**先确认学校是否已有官方实现**：[geek.sjtu.edu.cn](https://geek.sjtu.edu.cn/) 等官方平台的产品线，以及各业务系统是否已提供官方接口。

2026-09 的教训值得记住：官方桌面端 jAide 发布后，才发现与本项目功能高度重叠——双方都付出了一部分成本，而本可以更早对齐。**先查、再动手；如果确实重叠，优先考虑通过 MCP / 接口做互补，而不是再实现一遍。**
